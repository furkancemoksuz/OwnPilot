      ...
      <div>
        <button
          ...
          className={cn(
            ...
            depth === 0 && "font-semibold text-xs uppercase tracking-wider text-[var(--color-text-subtle)] hover:text-[var(--color-text-muted)] hover:bg-transparent"
          )}
        >
        ...
        {open && item.items && (
          <div className={cn("mt-0.5", depth === 0 ? "mb-4" : "ml-3 border-l border-[var(--color-border-subtle)] pl-3 mt-1")}>
